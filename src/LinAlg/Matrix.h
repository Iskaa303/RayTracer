...
class Matrix2
{
    ...
    // Matrix2 * Vector.
    template <class U> friend Vector<U> operator* (const Matrix2<U>& lhs, const Vector<U>& rhs);
    
    // Matrix2 * Vector3.
    template <class U> friend Vector3<U> operator* (const Matrix2<U>& lhs, const Vector3<U>& rhs);  
    
    // Matrix2 * Vector4.
    template <class U> friend Vector4<U> operator* (const Matrix2<U>& lhs, const Vector4<U>& rhs);      
...
// matrix * Vector4
template <class T>
Vector4<T> operator* (const Matrix2<T>& lhs, const Vector4<T>& rhs)
{
...
// matrix * Vector3
template <class T>
Vector3<T> operator* (const Matrix2<T>& lhs, const Vector3<T>& rhs)
{
	// Verify the dimensions of the inputs.
	if (lhs.m_nCols != 3)
	{
